(function() {
  ...
  _.shuffle = function(array) {
    let copyArray = array.slice(0, array.length);
    let shuffledArray = [];

    for (let i = 0; i < copyArray.length; i++) {
      let randomized = Math.floor(Math.random() * copyArray.length);
      let confirmed = Number(copyArray.splice(randomized, 1));
      i--;
      shuffledArray.push(confirmed);
    }
